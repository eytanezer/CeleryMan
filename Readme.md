...
* **Asymmetric Multiplayer:** * **Player 1 (The Husband):** Navigate the map, collect all required objectives, and reach the Home Goal to win.
  * **Player 2 (The Wife):** Hunt down Player 1! Catching the Husband after he collects his objectives triggers a custom "Beat Up" sequence and grants Player 2 the win.
* **Dynamic Obstacles:** Vehicles spawn across multiple lanes with varying speeds and stun mechanics.
