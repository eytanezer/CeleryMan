...
namespace ManagmentScripts.SoundScripts
{
    ...
    public class SoundManager : MonoSingleton<SoundManager >
    {
        ...
        private void PlayBGM(AudioClip newClip)
        {
            ...
            // // we don't have a BGM source yet, get one from the pool
            ...
            //     _currentBgmSource.Source.spatialBlend = 0; // 0 = 2D (sounds the same everywhere)
            // }
        ...
        private void OnEnable()
        {
            ...
            GameManager.OnGameStarted += TriggerGameplayMusic;
            GameManager.OnGameOver += TriggerGameOverMusic;
            
            // If resetting takes you back to the title screen, uncomment this:
            // GameManager.OnGameReset += TriggerTitleMusic; 
        }
